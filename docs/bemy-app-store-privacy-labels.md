...
- 2026-04-27 — Initial draft, derived from `bemy-v1-posthog-plan.md` §7. Performance Data row dropped per reviewer amendment §5 (PostHog RN does not auto-emit `$performance` events).

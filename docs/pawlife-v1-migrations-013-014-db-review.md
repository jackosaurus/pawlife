...
- All 16 constraint moves from NO ACTION → SET NULL match the audit in `docs/pawlife-v1-account-deletion-plan.md` §2 line-by-line. No omitted constraints, no spurious additions.
